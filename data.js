var elements = {
  ...
  "Promethium": {
    ...
    "oxidation_states": 3,
    "electronic_configuration": "[Xe]4f5d6s²",
    "lattice_structure": NaN,
    "lattice_constant ang": NaN
  },
  "Samarium": {
    "symbol": "Sm",
    "atomic_number": 62,
  ...
  "Curium": {
    ...
    "covalent_radius pm": NaN,
    "ionic_radius pm": "",
    "atomic_volume cm3/mol": 18.28,
    "specific_heat (@20°C J/g mol)": NaN,
    "fusion_heat (kJ/mol)": NaN,
    "evaporation_heat (kJ/mol)": NaN,
    "thermal_conductivity (@25°C W/m K) ": NaN,
    "pauling_negativity": 1.3,
  ...
  "Bohrium": {
    ...
    "pauling_negativity": NaN,
    "first_ionizing kJ/mol": NaN,
    "oxidation_states": NaN,
    "electronic_configuration": NaN,
    "lattice_structure": NaN,
    "lattice_constant ang": NaN
  },
  "Hassium": {
...
fs.writeFileSync('src/data/elements.json', JSON.stringify(data));